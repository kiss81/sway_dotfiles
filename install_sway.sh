...
# core install
sudo apt -y install build-essential git lm-sensors curl wget htop sshuttle usb-creator-gtk rfkill p7zip-full unrar
...
# multimedia
sudo curl -L https://github.com/yt-dlp/yt-dlp/releases/download/2023.12.30/yt-dlp -o /usr/local/bin/yt-dlp
